        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="user-block block text-center">
                    <div class="avatar"><img src="{{ asset('admincss/img/avatar-1.jpg') }}" alt="..."
                            class="img-fluid">
            ...
            <div class="col-lg-4">
                <div class="user-block block text-center">
                    <div class="avatar"><img src="{{ asset('admincss/img/avatar-4.jpg') }}" alt="..."
                            class="img-fluid">
        ...
        <div class="public-user-block block">
            <div class="row d-flex align-items-center">
                <div class="col-lg-4 d-flex align-items-center">
                    ...
                    <div class="avatar"> <img src="{{ asset('admincss/img/avatar-2.jpg') }}" alt="..."
                            class="img-fluid">
            ...
            <div class="col-lg-6">
                <div class="messages-block block">
                    ...
                    <div class="messages"><a href="#" class="message d-flex align-items-center">
                            ...
                            <div class="profile"><img src="{{ asset('admincss/img/avatar-5.jpg') }}" alt="..."
                                    class="img-fluid">
